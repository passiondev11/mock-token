...
module.exports = {
  ...
  networks: {
    ...
    mainnet: {
      provider: () => new PrivateKeyProvider(privateKey, 'wss://mainnet.infura.io/ws/v3/' + infuraId),
    ...
    rinkeby: {
      provider: () => new PrivateKeyProvider(privateKey, 'wss://rinkeby.infura.io/ws/v3/' + infuraId),
